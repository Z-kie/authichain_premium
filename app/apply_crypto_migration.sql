...
CREATE INDEX IF NOT EXISTS "CryptoPayment_nowpaymentsId_idx" ON "CryptoPayment"("nowpaymentsId");
CREATE INDEX IF NOT EXISTS "CryptoPayment_paymentStatus_idx" ON "CryptoPayment"("paymentStatus");
CREATE INDEX IF NOT EXISTS "CryptoPayment_createdAt_idx" ON "CryptoPayment"("createdAt");
CREATE INDEX IF NOT EXISTS "CryptoPayment_payAddress_idx" ON "CryptoPayment"("payAddress");

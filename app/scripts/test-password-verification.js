...
function testPasswordVerification() {
    return __awaiter(this, void 0, void 0, function () {
        var testCases, _i, testCases_1, testCase, user, isPasswordValid, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    console.log("\n========================================");
                    console.log("Testing: ".concat(testCase.email));
                    console.log("Password: ".concat(testCase.password));
                ...
                case 2:
                    ...
                    console.log("  - Password hash: ".concat(user.password.substring(0, 20), "..."));
                    return [4 /*yield*/, bcrypt.compare(testCase.password, user.password)];
                case 3:
